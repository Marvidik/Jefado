        ...
        <div style={{ background: 'var(--bg)', minHeight: '100vh', paddingBottom: '80px' }}>
            ...
            <div className="container" style={{ paddingTop: '40px' }}>
                ...
                <div className="products-grid" style={{ minHeight: '400px' }}>
                    {loading ? (
                        <div style={{ gridColumn: '1 / -1', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '100px 0', gap: '24px' }}>
                            <div style={{ position: 'relative', width: '64px', height: '64px' }}>
                                ...
                                <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', animation: 'pulse 1.5s ease-in-out infinite' }}>🤝</div>
                            </div>
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
                                <p style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '18px', color: 'var(--text-primary)', margin: 0, letterSpacing: '-0.3px' }}>Discovering professionals</p>
                                <p style={{ fontSize: '13px', color: 'var(--text-muted)', margin: 0 }}>Finding the best services for you...</p>
                            </div>
                            <style>{`
