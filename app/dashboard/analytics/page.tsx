    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '14px' }}>
                <StatCard icon={Icons.analytics} label="Page Views" value="48.5K" change="+32%" up sparkData={[20, 28, 24, 35, 30, 38, 35, 42]} color="var(--dash-primary)" />
                ...
                <StatCard icon={Icons.orders} label="Avg. Session" value="3m 24s" change="+8%" up sparkData={[2.8, 3, 2.9, 3.2, 3.1, 3.3, 3.2, 3.4]} color="var(--dash-primary)" />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <Card>
                    ...
                    <DonutChart segments={[
                        { label: 'Organic Search', value: 45, color: 'var(--dash-primary)' },
                        { label: 'Direct', value: 28, color: 'var(--dash-primary-light)' },
                        ...
                        <div key={p.name} style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '11px 13px', background: '#f8fafc', borderRadius: '9px' }}>
                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                <div style={{ height: '5px', background: '#e2e8f0', borderRadius: '3px', overflow: 'hidden' }}>
                                    <div style={{ width: `${(p.views / 4820) * 100}%`, height: '100%', background: 'var(--dash-primary)', borderRadius: '3px' }} />
                                </div>
                            </div>
