export default function FullWidthPromo() {
    return (
        <section className="container" style={{ padding: '0 var(--gutter) 28px' }}>
            <div className="promo-full" style={{ background: 'linear-gradient(120deg, #f8fafc 0%, #e8f0fe 100%)', borderRadius: 'var(--radius-xl)', padding: '36px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', border: '1px solid var(--border)', overflow: 'hidden', position: 'relative', gap: '20px' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <span style={{ display: 'inline-block', background: 'var(--primary)', color: '#fff', fontSize: '11px', fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', padding: '3px 12px', borderRadius: '20px', marginBottom: '14px' }}>Save up to $200.00</span>
                    ...
                    <button style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'var(--primary)', color: '#fff', padding: '12px 28px', borderRadius: 'var(--radius)', fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: '14px', boxShadow: '0 4px 20px rgba(26,86,219,0.3)' }}>Shop Now →</button>
                </div>
